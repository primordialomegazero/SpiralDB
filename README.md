...
License: MIT Go Docker NPM FHE Dependencies
...
Adding Enc(0) (additive identity) stabilizes noise growth.
Experimentally verified: 3X noise reduction vs ordinary addition.

Fibonacci Noise Dynamics:
Noise drops during squaring follow Fibonacci sequence:
- Drop per step: ~33-34 bits ≈ Fib(9) = 34
- 62.1% of noise drops hit Fibonacci numbers (|drop - Fib| ≤ 2)

Golden Ratio in FHE:
- Noise budget ratio at Step 3: 0.5926 ≈ 1/φ
- φ = 1.618... appears in self-referential operations (ct × ct)
